...
const MapView = ({ positions }) => {
  ...
  return (
    ...
    >
      <TileLayer
        attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors, CityBik.es API<li>Bike back&nbsp;&nbsp; <img src="./greenCircle.png"><img src="./bike-in-sm.png">&nbsp;&nbsp; | &nbsp; Bike out &nbsp; <img src="./redCircle.png"><img src="./bike-out-sm.png">&nbsp;</li>
