...
const MapView = ({ positions }) => {
  ...
  return (
    ...
    >
      <TileLayer
        attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>  data, CityBik.es API<li>Bike back&nbsp;&nbsp; <img src="./greenCircle.png">&nbsp;&nbsp; | &nbsp; Bike out &nbsp; <img src="./redCircle.png">&nbsp;</li>
